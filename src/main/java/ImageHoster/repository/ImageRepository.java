...
public class ImageRepository {
    ...
    public void deleteImage(Integer imageId) {
       ...
       // Comment comment=em.find(Comment.class,imageId);
       //     List <Comment>  comments= (List<Comment>) em.find(Comment.class, imageId);
       // em.remove(comments);
        em.remove(image);
        transaction.commit();
        } catch (Exception e) {
            //System.out.println("System is roll back from previous action");
        transaction.rollback();
        }
    }
